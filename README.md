...
# How to start
if you have Python witch is 3.10 or higher then just run the Project_Å_GUI.py as admin you can do that via CMD like this!
...
Unless if your wanting to use SOFC my home made programming language just download the lanagage.txt and SOFC.exe and run in console or CMD SOFC.exe -? or -H to know more!
